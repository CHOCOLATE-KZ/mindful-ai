  ...
  return (
    <div className="group relative overflow-hidden rounded-2xl bg-white p-8 shadow-xl border-2 border-blue-100 hover:border-blue-300 transition-all duration-300 hover:-translate-y-1">
      <div className="relative flex items-center justify-between mb-4">
        <span className="px-3 py-1 text-xs font-semibold rounded-full bg-[#74AA9C]/10 border border-[#74AA9C]/30 text-[#74AA9C]">
          {fact.category}
        </span>
      ...
      <div className="relative pt-4 border-t border-blue-100 flex items-center justify-between gap-3">
        ...
        <button
          onClick={onRefresh}
          className="flex items-center gap-1 px-4 py-2 text-sm font-semibold text-[#74AA9C] hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors"
        >
