    ...
    <div className="relative overflow-hidden rounded-2xl bg-white p-8 border-2 border-blue-100 shadow-xl hover:shadow-2xl hover:border-blue-300 transition-all duration-300 hover:-translate-y-1">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          <Lightbulb className="w-6 h-6 text-[#5479F7]" />
      ...
      <div className="flex items-center justify-between gap-3 pt-4 border-t border-blue-100">
        <div>
          ...
          <span className="inline-block px-3 py-1 text-xs font-semibold rounded-full bg-[#5479F7]/10 border border-[#5479F7]/30 text-[#5479F7]">
            {tip.category}
          </span>
        </div>
        <button
          onClick={onRefresh}
          className="flex items-center gap-1 px-4 py-2 text-sm font-semibold text-[#5479F7] hover:text-blue-700 hover:bg-blue-50 rounded-lg transition-colors"
        >
