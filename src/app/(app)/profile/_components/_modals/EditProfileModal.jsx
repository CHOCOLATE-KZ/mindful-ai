  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-center bg-black/40 px-4">
      <div className="w-full max-w-lg rounded-3xl border border-black/10 bg-white p-6 shadow-2xl">
        <div className="text-lg font-semibold text-black">{t("editProfile")}</div>
        ...
        <div className="mt-4 flex items-center gap-4">
          ...
          <label className="inline-flex cursor-pointer items-center rounded-full border border-black/10 bg-white px-4 py-2 text-sm font-medium text-black/80 transition hover:bg-black/[0.03]">
            {t("uploadAvatar")}
            <input
              type="file"
