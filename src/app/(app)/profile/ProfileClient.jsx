  ...
  const updateAllSettings = useCallback(
    async (patch) => {
      try {
        ...
        if (patch?.language && app?.updateSettings) {
          await app.updateSettings({ language: patch.language });
        }
      } catch (e) {
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="mx-auto max-w-5xl px-4 py-10">
        ...
        <div className="rounded-3xl border border-black/10 bg-white p-5">
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-sm font-medium text-black">Telegram</div>
        ...
        <div className="rounded-3xl border border-rose-200 bg-rose-50/50 p-5">
          <div className="flex items-start justify-between gap-4">
            <div>
              <div className="text-sm font-semibold text-rose-700">Удалить аккаунт</div>
            ...
            <button
              ...
              className="shrink-0 rounded-full border border-rose-300 bg-white px-4 py-2 text-sm font-medium text-rose-600 transition hover:bg-rose-600 hover:text-white"
            >
              Удалить
            </button>
          </div>
...
function SectionHeader({ icon, label, inner = false, danger = false }) {
  return (
    <div className={`flex items-center gap-2 ${inner ? "mt-5 mb-3" : "mt-10 mb-4"}`}>
      ...
      <div className={`flex-1 h-px ${danger ? "bg-rose-200/80" : "bg-slate-200/80"}`} />
    </div>
  );
}
