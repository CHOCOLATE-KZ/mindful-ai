    ...
    <div className="rounded-3xl border border-black/10 bg-white p-8 shadow-sm backdrop-blur-sm">
      <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
        <div className="flex-1">
          ...
          <div className="mt-2">
            <span className="inline-flex items-center rounded-md bg-blue-100/70 px-2.5 py-1 text-xs font-medium text-blue-700">{t("sleepHint")}</span>
          </div>
        </div>
        ...
        <div className="flex flex-wrap gap-3">
          <div className="group rounded-2xl border border-blue-200/50 bg-blue-50 px-5 py-3.5 shadow-sm hover:shadow-md transition-all">
            <div className="flex items-center gap-2">
              ...
              <div className="text-xs font-medium text-black/50">{t("avgMood")}</div>
            </div>
          ...
          <div className="group rounded-2xl border border-emerald-200/50 bg-emerald-50 px-5 py-3.5 shadow-sm hover:shadow-md transition-all">
            <div className="flex items-center gap-2">
              ...
              <div className="text-xs font-medium text-black/50">{t("avgSleep")}</div>
            </div>
          ...
          <div className="group rounded-2xl border border-blue-200/50 bg-blue-50 px-5 py-3.5 shadow-sm hover:shadow-md transition-all">
            <div className="flex items-center gap-2">
              ...
              <div className="text-xs font-medium text-black/50">{t("totalEntries")}</div>
            </div>
            <div className="mt-1.5 text-2xl font-bold text-blue-600">
              {fullNotesCount}
            ...
            <div className="text-[11px] text-black/50 font-medium mt-0.5">{t("fullPlusMini")}</div>
          </div>
        </div>
      </div>
    </div>
