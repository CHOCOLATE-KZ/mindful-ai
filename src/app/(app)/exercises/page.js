  ...
  return (
    <>
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/3 -left-32 h-80 w-80 rounded-full bg-blue-300/10 blur-3xl" />
        <div className="absolute bottom-0 right-1/4 h-96 w-96 rounded-full bg-blue-300/10 blur-3xl" />
      </div>
